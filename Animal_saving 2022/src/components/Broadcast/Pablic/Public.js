...
import classes from "./Pablic.module.css";
import classNames from "classnames";
export default function Public(props) {
    return (
        <div className={classes.chat_display}>
            <div className={classes.chat_list}>
                <div className={classes.chat_list__item}>
                    <span className={classNames(classes.chat_list__item_name)}>
                         Арнольд
                                                                                </span>
                    <span className={classes.chat_list__item_text}>
                         Отличное животное
                                                                                </span>
                </div>
                <div className={classes.chat_list__item}>
