...
<head>
    <title>Code coverage report for src/components/ObjectField.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> ObjectField.jsx</h1>
        <div class='clearfix'>
...
&nbsp;
    componentWillReceiveProps({ value = <span class="branch-0 cbranch-no" title="branch not covered" >{} </span>}) {
