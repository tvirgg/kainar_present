...
<head>
    <title>Code coverage report for src/components/Form.jsx</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> Form.jsx</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">99.32% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>146/147</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>140/141</span>
            </div>
...
export const setErrorOnSchema = (schema, path, error) =&gt; {
    if (isObject(error) || Array.isArray(error)) {
        Object.keys(error).forEach((key) =&gt; {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (error[key]) {
                <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof error[key] === 'string') {
                    schema.setModelError(path, error[key]);
                    return;
                }
<span class="cstat-no" title="statement not covered" >                setErrorOnSchema(schema, `${path}.${key}`, error[key]);</span>
            }
        });
        return;
    }
