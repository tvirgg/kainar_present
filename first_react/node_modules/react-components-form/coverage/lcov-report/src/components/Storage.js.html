...
<head>
    <title>Code coverage report for src/components/Storage.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/components</a> Storage.js</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">class Storage {
    constructor(model) {
        this.model = model || {};
        this.listeners = [];
    }
...
&nbsp;
export default Storage;</pre></td></tr></table></pre>
